...
<body>
	...
	<div class="rightinfo">
		...
		<table class="tablelist">
			...
			<tbody>
				<%
					for (VipRec vipRec : aList) {
				%>
				<tr>
					<td><%=vipRec.getId()%></td>
					<td><%=vipRec.getUser()%></td>
					<td>
						<%
							if (vipRec.getType() == 1) {
									out.print("添加");
								} else if (vipRec.getType() == 2) {
									out.print("修改");
								} else {
									out.print("删除");
								}
		...
		<div class="pagin">
			...
			<ul class="paginList">
				...
				%>
				<li class="paginItem"><a href="ShowVipRec.jsp?page=<%=i%>"><%=i%></a></li>
				<%
					}
				%>
			</ul>
